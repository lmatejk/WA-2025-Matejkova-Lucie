...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    // Validace POST dat (trim je na odstranění whitespace - např. mezera na konci)
    ...
    //přerušení uložení do databáze, pokud nesplňuje podmínky
    ...
    //pokud nedojde k přerušení předchozými podmínkami, provede se zápis do db
