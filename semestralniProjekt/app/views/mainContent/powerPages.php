...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark navbar-powerPages mb-4 sticky-top">
    ...
    <div class="container">
        <h1><img style="width: 150px;" src="../../assets/images/powerPages.svg" alt="Power Platform Logo"> Power Pages</h1>
    </div>    
...
<div class="container">
    ...
    <p>
        Power Pages umožňuje vytvoření webových stránek bez nutnosti hlubších programovacích znalostí. 
        ůžeme si vybrat template a nebo vytvořit vlastní stránku. Přátelské uživatelské rozhraní by nás mělo 
        jednoduše vést. Pokročilí uživatelé mohou využít i HTML. Obsahují také funkci, že pokud vyfotíme náš 
        nákres webové stránky na papíře, automaticky ho vytvoří a rozhodne například jaký typ tlačítka jsme chtěli. 
        Samozřejmě můžeme pak web měnit a aktualizovat.

    </p>

    <p>
        Díky propojení je snadné získávat data například z Dataverse a také tam data ukládat. 
        K tomu většinou napomáhá i integrace s Power Automate. Je možné bezpečně spravovat přístup jednotlivých uživatelů. 
    </p>

    <p>
        Díky propojení s dalšími nástroji, jako je Dataverse, je snadné získávat a ukládat data. 
        Integrace s Power Automate navíc umožňuje automatizaci procesů. 
        Přístup jednotlivých uživatelů lze bezpečně spravovat.
    </p>

    <p>
        Je určena především pro externí uživatele (např. odběratelé - objednávky, dodavatelé - vkládání faktur), 
        ale je možné využít i pro interní (správa docházky, přístup k firemním dokumentům - pro toto lze využít i SharePoint).
        Také můžeme do našich stránek integrovat chatboty díky propojení s Copilot Studiem.
    </p>

    <div class="card p-3">
            <h3>Uživatelské rozhraní</h3>
            <img src="../../assets/images/powerpages_app.png" alt="Uživateské rozhraní Power Pages">
    </div>
